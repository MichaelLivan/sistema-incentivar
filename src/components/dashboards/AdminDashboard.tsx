...
export const AdminDashboard: React.FC = () => {
  ...
  hourly_rate: 35, // ✅ Verificar se este valor está sendo aplicado
  assignedPatients: []
});
  ...
  // Handlers para AT
    ...
    await apiService.updateUser(editingAT, {  // ✅ Correto
      name: newATForm.name,
      sector: newATForm.sector,
      hourly_rate: newATForm.hourly_rate
    });
    ...
    await apiService.createUser({  // ✅ Correto - usar createUser
      name: newATForm.name,
      email: newATForm.email,
      type: `at-${newATForm.sector}`,
      sector: newATForm.sector,
...
<div className="mt-6">
  ...
  </div> {/* ← Esta div fecha o overflow-x-auto */}
</div> {/* ← Esta div fecha o mt-6 */}
        </CardContent>
      </Card>
